package com.skill.job.domain;

import com.fasterxml.jackson.annotation.JsonFormat;
import com.skill.common.annotation.Excel;
import com.skill.job.constant.ScheduleConstants;
...
public class SysJob extends BaseEntity implements Serializable {
    ...
    public String getMisfirePolicyName() {
        return misfirePolicyName;
    }

    public void setMisfirePolicyName(String misfirePolicyName) {
        this.misfirePolicyName = misfirePolicyName;
    }
    ...
    public String getInvokeTargetName() {
        return invokeTargetName;
    }

    public void setInvokeTargetName(String invokeTargetName) {
        this.invokeTargetName = invokeTargetName;
    }
