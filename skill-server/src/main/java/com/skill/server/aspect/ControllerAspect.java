package com.skill.server.aspect;

import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.skill.server.constant.MdcConstant;
import com.skill.server.utils.IpUtil;
...
public class ControllerAspect {
    ...
    @Pointcut("execution(public * com.skill.server.controller.*.*(..))")
    public void webLog() {}
