      ...
      <a-tabs type="card">
        <a-tab-pane key="1" type="card">
          ...
          <a-radio-group v-model="result.second.cronEvery">
            ...
            <a-row>
              <a-radio value="2">每隔
                <a-input-number v-model="result.second.incrementIncrement" size="small" :min="1" :max="60"></a-input-number>
                秒执行 从
                <a-input-number v-model="result.second.incrementStart" size="small" :min="0" :max="59"></a-input-number>
                秒开始
              </a-radio>
            </a-row>
            <a-row>
            ...
            <a-row>
              <a-radio value="4">周期从
                <a-input-number v-model="result.second.rangeStart" size="small" :min="1" :max="60"></a-input-number>
                到
                <a-input-number v-model="result.second.rangeEnd" size="small" :min="0" :max="59"></a-input-number>
                秒
              </a-radio>
            </a-row>
          </a-radio-group>
        ...
        <a-tab-pane key="2">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.minute.cronEvery">
              ...
              <a-row>
                <a-radio value="2">每隔
                  <a-input-number v-model="result.minute.incrementIncrement" size="small" :min="1" :max="60"></a-input-number>
                  分执行 从
                  <a-input-number v-model="result.minute.incrementStart" size="small" :min="0" :max="59"></a-input-number>
                  分开始
                </a-radio>
              </a-row>
              <a-row>
              ...
              <a-row>
                <a-radio value="4">周期从
                  <a-input-number v-model="result.minute.rangeStart" size="small" :min="1" :max="60"></a-input-number>
                  到
                  <a-input-number v-model="result.minute.rangeEnd" size="small" :min="0" :max="59"></a-input-number>
                  分
                </a-radio>
              </a-row>
            </a-radio-group>
        ...
        <a-tab-pane key="3">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.hour.cronEvery">
              ...
              <a-row>
                <a-radio value="2">每隔
                  <a-input-number v-model="result.hour.incrementIncrement" size="small" :min="0" :max="23"></a-input-number>
                  小时执行 从
                  <a-input-number v-model="result.hour.incrementStart" size="small" :min="0" :max="23"></a-input-number>
                  小时开始
                </a-radio>
              </a-row>
              <a-row>
              ...
              <a-row>
                <a-radio value="4">周期从
                  <a-input-number v-model="result.hour.rangeStart" size="small" :min="0" :max="23"></a-input-number>
                  到
                  <a-input-number v-model="result.hour.rangeEnd" size="small" :min="0" :max="23"></a-input-number>
                  小时
                </a-radio>
              </a-row>
            </a-radio-group>
        ...
        <a-tab-pane key="4">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.day.cronEvery">
              ...
              <a-row>
                <a-radio value="2">每隔
                  <a-input-number v-model="result.week.incrementIncrement" size="small" :min="1" :max="7"></a-input-number>
                  周执行 从
              ...
              <a-row>
                <a-radio value="3">每隔
                  <a-input-number v-model="result.day.incrementIncrement" size="small" :min="1" :max="31"></a-input-number>
                  天执行 从
                  <a-input-number v-model="result.day.incrementStart" size="small" :min="1" :max="31"></a-input-number>
                  天开始
                </a-radio>
              </a-row>
              <a-row>
              ...
              <a-row>
                <a-radio value="9">
                  在本月底前
                  <a-input-number v-model="result.day.cronDaysBeforeEomMinus" size="small" :min="1" :max="31"></a-input-number>
                  天
                </a-radio>
              </a-row>
              <a-row>
                <a-radio value="10">最近的工作日（周一至周五）至本月
                  <a-input-number v-model="result.day.cronDaysNearestWeekday" size="small" :min="1" :max="31"></a-input-number>
                  日
                </a-radio>
              </a-row>
              <a-row>
                <a-radio value="11">在这个月的第
                  <a-input-number v-model="result.week.cronNthDayNth" size="small" :min="1" :max="5"></a-input-number>
                  个
        ...
        <a-tab-pane key="5">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.month.cronEvery">
              ...
              <a-row>
                <a-radio value="2">每隔
                  <a-input-number v-model="result.month.incrementIncrement" size="small" :min="0" :max="12"></a-input-number>
                  月执行 从
                  <a-input-number v-model="result.month.incrementStart" size="small" :min="0" :max="12"></a-input-number>
                  月开始
                </a-radio>
              </a-row>
              <a-row>
              ...
              <a-row>
                <a-radio value="4">从
                  <a-input-number v-model="result.month.rangeStart" size="small" :min="1" :max="12"></a-input-number>
                  到
                  <a-input-number v-model="result.month.rangeEnd" size="small" :min="1" :max="12"></a-input-number>
                  月之间的每个月
                </a-radio>
              </a-row>
            </a-radio-group>
        ...
        <a-tab-pane key="6">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.year.cronEvery">
              ...
              <a-row>
                <a-radio value="2">每隔
                  <a-input-number v-model="result.year.incrementIncrement" size="small" :min="1" :max="99"></a-input-number>
                  年执行 从
                  <a-input-number v-model="result.year.incrementStart" size="small" :min="2019" :max="2119"></a-input-number>
                  年开始
                </a-radio>
              </a-row>
              <a-row>
              ...
              <a-row>
                <a-radio value="4">从
                  <a-input-number v-model="result.year.rangeStart" size="small" :min="2019" :max="2119"></a-input-number>
                  到
                  <a-input-number v-model="result.year.rangeEnd" size="small" :min="2019" :max="2119"></a-input-number>
                  年之间的每一年
                </a-radio>
              </a-row>
            </a-radio-group>
...
<style scoped>
  ...
  .card-container .bottom .cronButton{
    margin: 0 10px;
    line-height: 40px;
  }
  .tabBody .a-row .long .a-select{
    width:354px;
  }
  .tabBody .a-row .long .a-input-number{
    width: 110px;
  }
</style>
