...
import { UserLayout, RouteView, PageView, BasicLayout } from '@/layouts'
...
export const defaultRouterMap = [
  ...
  //       key: 'DataCenter',
  //       icon: '',
  //       component: 'unit/DataCenter'
  //       // component: 'unit/DataCenter.vue'
  //     }
  //   ]
  // },
  // {
...
// const UNIT_ROOM = isProd ? {} : {
//   path: '/DataCenter',
//   name: 'DataCenter',
//   component: () => import(/* webpackChunkName: "DataCenter" */ '@/views/unit/DataCenter')
// }
/**
 * 基础路由
 * @type { *[] }
...
export const constantRouterMap = [
  ...
  // },
  {
    path: '/homeNoPermission',
    component: BasicLayout,
    children: [
      {
        path: '',
        name: 'homeNoPermission',
        component: () => import(/* webpackChunkName: "homeNoPermission" */ '@/views/home/homeNoPermission')
      }
    ]
  },
  {
    path: '/ssoLogin',
    name: 'ssoLogin',
    component: () => import(/* webpackChunkName: "ssoLogin" */ '@/views/user/SsoLogin')
  },
  {
    path: '/system',
    component: BasicLayout,
    children: [
      {
        ...
        component: () => import(/* webpackChunkName: "system" */ '@/views/system/SysJobLogList')
      }
    ]
  },
  {
        ...
        children: [
          {
            title: 'scenetest',
            path: 'scenetest',
            name: 'TestSunideaScenetest',
            hiddenHeaderContent: 0,
            hideChildrenInMenu: 0,
            component: () => import(/* webpackChunkName: "TestSunideaScenetest" */ '@/views/test/sunidea/Scenetest.vue')
          }
        ]
      }
    ]
