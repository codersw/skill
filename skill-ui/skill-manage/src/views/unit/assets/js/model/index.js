...
export let camera = new THREE.PerspectiveCamera(45,
  ...
  1, 1000)
//  控制器
export let control = new OrbitControls(camera, labelRenderer.domElement)
export const init = (dom) => {
  ...
  //  控制器
  if (!control) control = new OrbitControls(camera, labelRenderer.domElement)
...
export const modelUtils = {
  ...
  //   console.log('12345')
  // }
  controlPosition: animation.controlPosition,
  cameraPosition: animation.cameraPosition,
  controlAndCameraPosition: animation.controlAndCameraPosition
}
// 绘制射线(箭头射线)
