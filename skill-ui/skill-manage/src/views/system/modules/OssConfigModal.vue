  ...
  >
    <a-form :form="form">
      ...
      <a-form-item
        ...
        label="域名"
      >
        <a-input v-decorator="['qiniuDomain', {rules: [{ required: false, message: '请输入域名' }]}]" placeholder="域名" />
      </a-form-item>
      ...
      <a-form-item
        ...
        label="路径前缀"
      >
        <a-input v-decorator="['qiniuPrefix', {rules: [{ required: false, message: '请输入路径前缀' }]}]" placeholder="路径前缀" />
      </a-form-item>
