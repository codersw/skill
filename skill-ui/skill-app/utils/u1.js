let activities = [
  ...
  { name: "摸鱼", good: "只有摸鱼得到的工资才是赚到的", bad: "只有摸鱼得到的工资才是赚到的", weekend: true },
  ...
  { name: "命名变量\"%v\"", good: "很舒服的单词", bad: "会被领导骂" },
  ...
  { name: "打LOL", good: "你将局局超神", bad: "你会被虐的很惨", weekend: true },
  { name: "玩吃鸡", good: "你将有如神助", bad: "你会把把落地成盒", weekend: true },
  ...
  { name: "需求评审", good: "耐心分析需求", bad: "浪费时间" },
  ...
  { name: "频繁去厕所", good: "合理利用上厕所来摸鱼", bad: "每次去半个小时" },
  { name: "早退旷工", good: "心情不好早点回家", bad: "会被开除" },
  { name: "迟到不打卡", good: "心情不好晚点上班", bad: "会被扣掉满勤" }
];
let tools = ["Eclipse写程序", "MSOffice写文档", "记事本写程序", "Windows8", "Linux", "MacOS", "IE", "Android设备", "iOS设备"];
let varNames = ["jieguo", "huodong", "pay", "expire", "zhangdan", "every", "free", "i1", "a", "virtual", "ad", "spider", "mima", "pass", "ui"];
