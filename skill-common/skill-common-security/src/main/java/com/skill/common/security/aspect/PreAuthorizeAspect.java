package com.skill.common.security.aspect;
...
import com.skill.common.core.exception.PreAuthorizeException;
...
public class PreAuthorizeAspect {
    ...
    @Around("@annotation(com.skill.common.security.annotation.PreAuthorize)")
